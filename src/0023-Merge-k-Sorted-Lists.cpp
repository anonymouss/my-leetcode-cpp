...
int  main() {
    ...
    ListNode *l11 = new ListNode(0), *l12 = new ListNode(0),
             *l13 = new ListNode(0);
    myGenerateList(l11, arr11, 3), myGenerateList(l12, arr12, 3),
    myGenerateList(l13, arr13, 2);
    lists1.emplace_back(l11->next); lists1.emplace_back(l12->next);
    lists1.emplace_back(l13->next);
